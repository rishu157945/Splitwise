...
public class Splitwise {
    ...
    public void demo() {
        ...
        splits.add(split2);
        splits.add(split3);
        group.createExpense("Exp1001", "Breakfast", 900, splits, ExpenseSplitType.EQUAL_SPLIT, userController.getUser("U1001"));
        ...
        group.createExpense("Exp1002", "Lunch", 500, splits2, ExpenseSplitType.UNEQUAL_SPLIT, userController.getUser("U2001"));
